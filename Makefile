...
OBJS += src/a7105.o src/accelerometer.o src/autotune.o src/bradwii.o src/checkboxes.o src/eeprom.o src/gyro.o src/imu.o  src/output.o src/pilotcontrol.o src/serial.o src/rx_x4.o src/vectors.o src/config_X4.o
